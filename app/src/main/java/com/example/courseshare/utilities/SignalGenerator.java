package com.example.courseshare.utilities;
...
{
    private static SignalGenerator instance; //our single appearance instance. the first needed thing for singleton a static object that is the type of the class itself.
